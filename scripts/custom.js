...
$( document ).ready(function() {
	...
	$('.simple-search-modal').click(function() {
		$('.simple-search-modal-content').modal();
	});
	
	$('.simple-chat-modal').click(function() {
		$('.simple-chat-modal-content').modal();
	});
	...
	$('.social-profile-modal-2').click(function() {
		$('.social-profile-modal-2-content').modal();
	});
