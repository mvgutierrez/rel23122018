function validate(){
	...
	if(document.getElementById("categoria").value == ""){
		...
		var comercio = document.getElementById("categoria").value.split("-")[0];
		if(imagenPromo.value != ""){
			...
			document.getElementById("alertMessage").innerHTML = "Debe ingresar la imagen del banner.";
			$('.simple-modal-content').modal();
		}
	}
}